...
import org.scalajs.dom.raw.{Event, MessageEvent, CloseEvent}
...
case class WebSocketGraphQLClient(uri: String)(implicit val timerIO: Timer[IO], val csIO: ContextShift[IO])
  ...
  protected def createClientInternal(
    ...
    onClose: Boolean => Unit
      ...
      ws.onerror = { e: Event =>
        ...
        onError(exception.getOrElse[Exception](exception.swap.getOrElse(new Exception("Unexpected empty Either"))))
      }
